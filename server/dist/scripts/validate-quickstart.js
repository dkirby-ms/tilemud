...
async function main() {
    ...
    try {
        ...
        if (joinResult.latency)
            result.handshakeLatencyMs = Number(joinResult.latency.toFixed(2));
    }
    finally {
...
//# sourceMappingURL=validate-quickstart.js.map
...
export class LobbyRoom extends Room {
    ...
    async handleInstanceRequest(client, rawPayload) {
    ...
    parseCreateOrJoinRequest(rawPayload) {
        ...
        const mode = rawMode === "solo" ? "solo" : "matchmaking";
    ...
    findJoinableInstance(rulesetVersion) {
    ...
    sendInstanceReady(client, payload) {
    ...
    sendInstanceError(client, payload) {

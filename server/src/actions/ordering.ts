...
export function comparePriorityDescriptors(
  a: ActionPriorityDescriptor,
  b: ActionPriorityDescriptor
): number {
...
export function compareActionRequests(a: ActionRequest, b: ActionRequest): number {
  const descriptorComparison = comparePriorityDescriptors(
    getActionPriorityDescriptor(a),
    getActionPriorityDescriptor(b)
  );
...
export function sortActionRequests<T extends ActionRequest>(actions: T[]): T[] {
